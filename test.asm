...
int main(int argc, char *argv[])
{
   ...
   if(pid==0){
    ...
    1010:	75 38                	jne    104a <main+0x4a>
   int x=1;
   printf(1, "address %x\n", &x);
    1012:	8d 44 24 1c          	lea    0x1c(%esp),%eax
    1016:	89 44 24 08          	mov    %eax,0x8(%esp)
    101a:	c7 44 24 04 a3 17 00 	movl   $0x17a3,0x4(%esp)
    1021:	00 
...
{
   test(n+1);
    1036:	8b 44 24 1c          	mov    0x1c(%esp),%eax
    103a:	83 c0 01             	add    $0x1,%eax
    103d:	89 04 24             	mov    %eax,(%esp)
    1040:	e8 1b 00 00 00       	call   1060 <test>
   ...
   wait();
    104a:	e8 5b 02 00 00       	call   12aa <wait>
    104f:	90                   	nop
   exit();
    1050:	e8 4d 02 00 00       	call   12a2 <exit>
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    ...
    1399:	0f b6 92 b6 17 00 00 	movzbl 0x17b6(%edx),%edx
  }while((x /= base) != 0);
...
putc(int fd, char c)
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    152f:	8b 38                	mov    (%eax),%edi
        ...
        if(s == 0)
          s = "(null)";
    1531:	b8 af 17 00 00       	mov    $0x17af,%eax
